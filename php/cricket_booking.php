...
$username = "root"; 
$password = ""; 
$dbname = "cus_login";  // Change this to your database name
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($selectedSlots as $slot) {
        $sql = "INSERT INTO slotss (date, slot) VALUES ('$selectedDate', '$slot')";
...
<div class="container">
    ...
    <div class="slot_booking_form">
        <div class="calendar-container">
            <h2>Calendar</h2>
            <div id="calendar">
            <input type="date" id="date" name="date" required value="<?php echo isset($_POST['date']) ? $_POST['date'] : ''; ?>">
...
function bookSlot(date, slotId) {
    ...
    var index = selectedSlots.indexOf(slotId);
    if (index === -1) {
