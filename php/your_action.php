...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($selectedSlots as $slot) {
        $sql = "INSERT INTO bookings (date, slot) VALUES ('$selectedDate', '$slot')";
...
<div class="container">
    ...
    <div class="slot_booking_form">
        ...
        <form id="bookingForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return validateForm()">
